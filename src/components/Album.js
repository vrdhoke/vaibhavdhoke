...
export default function App() {
  ...
  useEffect(() => void setInterval(() => set(shuffle), 7000), [])
  ...
  return (
    ...
    <div {...bind} class="list" style={{ height: Math.max(...heights) }}>
        <br></br>
        {<h1 style={{display: "flex",justifyContent:"center"}}>Photography</h1>}
        <br></br>
        {<p style={{display: "flex",justifyContent:"center"}}>Check out some of my featured clicks</p>}
        <br></br>
